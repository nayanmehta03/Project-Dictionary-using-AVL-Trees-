...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, SQLDataException {

        Dictionary dictionary = new Dictionary();
        Dictionary dic = null ;
        Scanner sc = new Scanner(System.in);
        InputStream is = new FileInputStream("D:\\dictionary.txt");
        ...
        String line = buf.readLine();
           ...
           // dictionary = Dictionary.deSerialize();
            while (true)
            {
                ...
                System.out.println( dic.search(Dictionary.capitalizeWord(sc.next())));
            }
